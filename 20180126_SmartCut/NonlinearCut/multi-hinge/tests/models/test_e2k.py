...
def test_e2k():
    ...
    materials = {'STEEL': 35153.48, 'CONC': 2800.0, 'C350': 3500.0, 'C280': 2800.0, 'C245': 2450.0,
                 'C210': 2100.0, 'C420': 4200.0, 'C490': 4900.0, 'A615Gr60': 42184.18, 'RMAT': 42000.0}

    sections = {'B60X80C28': {'FC': 'C280', 'D': 0.8, 'B': 0.6, 'JMOD': 0.0001, 'I2MOD': 0.7, 'I3MOD': 0.7, 'FY': 'RMAT',
                              'FYH': 'RMAT'}, 'C90X90C28': {'FC': 'C280', 'D': 0.9, 'B': 0.9, 'JMOD': 0.0001, 'I2MOD': 0.7, 'I3MOD': 0.7}}

    point_coordinates = {'1': np.array([0.0, 0.0]), '2': np.array([8.0, 0.0])}
    lines = {'B1': ['1', '2']}
