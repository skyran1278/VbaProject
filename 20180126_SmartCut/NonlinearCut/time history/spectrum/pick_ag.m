...
% filenames = [
%   "RSN960_NORTHR_LOS270", "RSN1602_DUZCE_BOL000", "RSN169_IMPVALL.H_H-DLT352", "RSN1111_KOBE_NIS090", "RSN1158_KOCAELI_DZC270", "RSN848_LANDERS_CLW-LN", "RSN752_LOMAP_CAP090", "RSN1633_MANJIL_ABBAR--L", "RSN725_SUPER.B_B-POE270", "RSN1485_CHICHI_TCU045-N", "RSN125_FRIULI.A_A-TMZ000",
% ];
...
for index = 1 : length(filenames)
  ...
  title(filenames(index), 'Interpreter', 'none');
  xlabel('T(sec)');
  ylabel('Sa(g)');
