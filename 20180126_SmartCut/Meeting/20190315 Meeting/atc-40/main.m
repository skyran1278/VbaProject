...
plot(sd_triangle, scaled_factor, 'DisplayName', 'Elastic', 'Color', green, 'LineWidth', 1.5);
plot(sd_uniform, scaled_factor, 'DisplayName', 'Elastic', 'Color', blue, 'LineWidth', 1.5);
plot(sd_power, scaled_factor, 'DisplayName', 'Elastic', 'Color', red, 'LineWidth', 1.5);
...
ylabel('sa(g)');
plot(sd_triangle * PF1_phi, sa_triangle, 'DisplayName', 'Elastic', 'Color', green, 'LineWidth', 1.5);
plot(sd_uniform * PF1_phi, sa_uniform, 'DisplayName', 'Elastic', 'Color', blue, 'LineWidth', 1.5);
plot(sd_power * PF1_phi, sa_power, 'DisplayName', 'Elastic', 'Color', red, 'LineWidth', 1.5);
