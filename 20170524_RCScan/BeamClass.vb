...
Function PrintError(Optional ByVal error)
'
' descrip.
'
' @since 1.0.0
...
'
    ...
    If Not IsEmpty(error) Then
        collectErrorMessage. Add "Error # " & Str(error.Number) & " was generated by " & error.Source & ControlChars.CrLf & error.Description
    End If
